...
.card-preview h2{margin-bottom:10px;}
...
<p>This is something I truly mean 💗</p>
...
<h1>Thank You 💖</h1>
<p>
You just made my day brighter.<br>
I hope this moment becomes something we both remember.
</p>
...
<div class="decor" style="top:50%;left:5%;">🌷</div>
</div>
...
<div class="sparkle" style="left:-20px;top:30px;">✨</div>
<div class="sparkle" style="right:-20px;top:50px;">✨</div>
</div>

<div class="card" id="questionCard">
<h1>Will you be my Valentine?</h1>
<p>This means more than you think 💗</p>
<button class="yes" onclick="sayYes()">Yes 💕</button>
<button class="no" id="noBtn">Really sure?</button>
</div>
...
<h1>Thank You 💖</h1>
<p>
You just made something simple feel extraordinary.
</p>
<button class="generate" onclick="showForm()">Make a Valentine Card</button>
</div>
...
/* Heart eyes */
document.getElementById("eyeL").outerHTML='<text x="68" y="110" font-size="22">❤</text>';
document.getElementById("eyeR").outerHTML='<text x="108" y="110" font-size="22">❤</text>';
